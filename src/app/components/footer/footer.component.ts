...
@Component({
  ...
  <footer style="border-top:1px solid var(--border);">
    <div class="container-main py-8 flex flex-col sm:flex-row items-center justify-between gap-4">
      ...
      <div class="flex items-center gap-5 text-xs" style="color:var(--text-3); font-family:var(--mono);">
        ...
        <a href="https://github.com/moestilos" target="_blank" rel="noopener noreferrer"
           class="hover:text-white transition-colors flex items-center gap-1.5" style="color:var(--text-3)"
           aria-label="GitHub">
