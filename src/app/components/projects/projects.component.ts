...
const FALLBACK_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    demoUrl: 'https://moe-pdf.vercel.app',
    codeUrl: 'https://github.com/moestilos/MoePDF',
  },
  {
    num: '03',
    name: 'Arcane Harvest',
    tagline: 'Juego incremental autoclicker con temática arcana',
    description: 'Juego web incremental tipo autoclicker ambientado en un mundo arcano. Mecánicas de recolección, mejoras progresivas y automatización con loop de juego adictivo. Desarrollo frontend completo con estado persistente y sistema de progresión escalable.',
    highlights: [
      'Loop de juego incremental con mecánicas de click y automatización progresiva',
      'Sistema de mejoras y progresión escalable con múltiples capas de contenido',
      'Deploy en Vercel con estado de partida persistente en el navegador',
    ],
    image: 'images/arcane-harvest.png',
    type: 'Game · Frontend',
    year: '2026',
    slices: [
      { name: 'Next.js / TS',  pct: 50, color: '#000000' },
      { name: 'Tailwind CSS',  pct: 25, color: '#38bdf8' },
      { name: 'React',         pct: 25, color: '#61dafb' },
    ],
    demoUrl: 'https://arcane-harvest.vercel.app/',
    codeUrl: 'https://github.com/moestilos/arcane-harvest',
  },
  {
    num: '04',
    name: 'FunkMoes',
